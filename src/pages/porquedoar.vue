...
<div class="q-pa-md">
  ...
  <div class="row justify-center">
    ...
    <p>- O sangue doado é fundamental no tratamento dos pacientes;</p>
    <p>- Doar sangue é um acto humanitário, traz uma satisfação interior e faz bem a todos.</p>

    <h4>Pacientes que podem ser beneficiados com o sangue que você doar:</h4>
    <p>- Vítimas de diversos acidentes;</p>
    <p>- Pacientes com câncer ou tumores;</p>
    <p>- Pacientes hemofílicios;</p>
    <p>- Pacientes que serão submetidos a cirurgias;</p>
    <p>- Recém nascidos prematuros.</p>
